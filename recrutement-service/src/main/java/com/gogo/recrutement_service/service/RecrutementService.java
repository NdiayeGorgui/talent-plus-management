...
public interface RecrutementService {
    ProcessusDTO createProcessus(Long candidatId, Long offreId) throws NotificationException, CandidatNotFoundException, OffreNotFoundException;
    ProcessusDTO updateStatut(Long processusId, String nouveauStatut) throws NotificationException, ProcessusNotFoundException;
